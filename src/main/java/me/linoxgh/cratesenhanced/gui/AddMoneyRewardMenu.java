...
public class AddMoneyRewardMenu {
    ...
    private final int[] CLICKABLE = {10, 11, 12, 14, 15, 16, 28, 29, 30, 32, 33, 34};
    ...
    public void populate() {
        ...
        helpMeta.setLocalizedName("§bAlter the amount of money to give");
        help.setItemMeta(helpMeta);
        inv.setItem(22, help);

        ItemStack add100M = new ItemStack(Material.GOLD_BLOCK);
        ItemMeta add100MMeta = add100M.getItemMeta();
        add100MMeta.setLocalizedName("§6Press to increase money by 100");
        ...
        add1MMeta.setLocalizedName("§6Press to increase money by 1");
        ...
        add01MMeta.setLocalizedName("§6Press to increase money by 0.01");
        ...
        sub1MMeta.setLocalizedName("§6Press to decrease money by 1");
        ...
        sub100MMeta.setLocalizedName("§6Press to decrease money by 100");
