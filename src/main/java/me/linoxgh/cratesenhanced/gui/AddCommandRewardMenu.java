...
public class AddCommandRewardMenu {
    ...
    public AddCommandRewardMenu() {
        inv = Bukkit.createInventory(null, 45, Component.text("§3CratesEnhanced §e- §9Adding a Command Reward"));
        populate();
    }
    ...
    public void populate() {
        ...
        helpMeta.displayName(Component.text("§bWrite the command into a book and put into slot"));
